...
In an ideal universe socks should not have holes, but one of them apparently has a hole.
...
around over the points and back over the handles, and the
...
\parbf{\ref{ex:kuratowski}}; \ref{SHORT.ex:closure-closure}.
Each of the four statements can be deduced by spelling out the needed definition.

\parit{\ref{SHORT.ex:kuratowski-c}.} Use part \ref{SHORT.ex:closure-closure} together with the definitions of closure and interior.

\parit{\ref{SHORT.ex:kuratowski-closed}.}
Observe that $\mathring Q\subset Q$, and apply part \ref{SHORT.ex:kuratowski-c}.

\parit{\ref{SHORT.ex:kuratowski-open}.}
Observe that $\bar V\supset V$, and apply part \ref{SHORT.ex:kuratowski-c}.

\parit{\ref{SHORT.ex:kuratowski:kuratowski}.}
...
\parit{\ref{SHORT.ex:kuratowski:kuratowski7}.}
