...
Note that any ball $\Ball(x_\infty,\eps)$ is a neighborhood of $x_\infty$.
Observe that it implies the only-if part.

To prove the if part, show and use that for any neighborhood $N$ of $x_\infty$ there is $\eps>0$ such that $\Ball(x_\infty,\eps)\subset N$.
