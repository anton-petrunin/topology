...
\parit{Comment.}
Try to deduce from the last statement that the set of primes is infinite.
The resulting proof is not truly new; it is just a topological reformulation of the classical proof from Euclid's Elements.
...
\parbf{\ref{ex:path-connected-component-closed}.}
Read about lexicographic order topology, and apply it to the unit square.
