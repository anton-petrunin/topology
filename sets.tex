...
\begin{subthm}{ex:closure-closure}
Show that the following holds for any set $A$ in a topological space:
...
\begin{subthm}{ex:kuratowski-closed}
Show that 
\[\bar{\mathring Q}\subset Q\]
for any closed set $Q$.
\end{subthm}

\begin{subthm}{ex:kuratowski-open}
Show that 
...
\begin{subthm}{ex:kuratowski:kuratowski7}
Show that given a set $A$ one can get at most 7 distinct subsets by repeatedly applying the set operations of closure and interior.
\end{subthm}
