...
are continuous.%
\footnote{The term \textit{homomorphism} from abstract algebra looks similar and it has a similar meaning but should not be confused with a \textit{homeomorphism}.}
...
Observe that a homeomorphism can be defined as a \textit{continuous open bijection}.
