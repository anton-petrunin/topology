...
\item  A typical distance-nonexpanding map $f\:\SS^2\z\to\RR^2$ is \index{length-preserving map}\emph{length-preserving}; that is, $\length f\circ\gamma=\length \gamma$ for any curve $\gamma\:[a,b]\to \SS^2$.
