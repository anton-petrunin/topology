...
You probably heard that for topologists, \textit{two shapes are the same if
...
So, imagine an object made from endlessly stretchy material that can be twisted and pulled like a chewing gum;
...
\vskip-2mm
\centering
\includegraphics[scale=.021]{pics/mug-to-donut}
\end{wrapfigure}
...
(it will be eventually proved in our course).
So, at least not all shapes are topologically equivalent.

\begin{wrapfigure}[2]{r}{47 mm}
\vskip-4mm
\centering
...
In the morning, a topologist looks at his clothes; there should be a T-shirt, pants, and socks.
...
He picked the mug up, turned it over, looked at the bottom, and said:
...
At this point, you might think that topology has no practical value, and you are almost right.
Altho, thinking topologically, it is very easy to solve some puzzles:
...
Try to get the scissors off without cutting the string or releasing the ends.
\end{subthm}
