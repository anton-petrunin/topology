...
Show that that arithmetic progressions $\{a,a+d,a+2\cdot d,\dots\}$ for relatively prime all realtivley prime positive integers $a\le d$ form a basis of some topology, and $\NN$ equipped with this topology is a connected Hausdorff space.
\end{thm}
