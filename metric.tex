...
Give an example of a metric space $\c{X}$ and an infinite sequence of open sets $V_1,V_2,\dots$
...
In this case, we say that the sequence $x_1,x_2,\dots$ is \index{convergence}\emph{converging} and $x_\infty$ is its \index{limit}\emph{limit};
