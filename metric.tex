...
A map $f\:\c{X}\to\c{Y}$ between metric spaces is called \index{continuous map}\emph{continuous} if for any $x\in \c{X}$ and any $\eps>0$ there exists $\delta>0$ such that 
