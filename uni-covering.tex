...
Suupose $\c{Z}$ is a connected reasonable space and both spaces $\c{X}$ and $\c{Y}$ are simply-connected.
...
\parit{Proof.}
Recall that the induced homomorphism of composition is compostion of induced homomorphisms; see \ref{ex:comp-induced}.
