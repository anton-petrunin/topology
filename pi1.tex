...
If we need to talk about general homotopy of paths we say \emph{free homotopy}.
...
\begin{thm}{Exercise}
Let $G$ be a \emph{topological group}; that is a group equipped with topology such that the maps $G\times G\to G$ and $G\to G$ defined by $(g,h)\mapsto g\cdot h$ and $g\mapsto g^{-1}$ are continuous.
