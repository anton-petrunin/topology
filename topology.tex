...
In 1922, the definition was generalized slightly by Kazimierz Kuratowski, and it is now standard.
...
From part \ref{def:top-space:n} it follows that the intersection of a finite collection of open sets is open.
