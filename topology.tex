...
\item  The \index{concrete topology}\emph{concrete topology} (also known as \emph{trivial topology}) --- the topology consisting of just the whole set $\c{X}$ and the empty set, $\emptyset$.
...
Let us also mention the \emph{Zariski topology}: it is a topology on $\RR^n$ in which the open sets are complements of solution sets of systems of algebraic equations.
