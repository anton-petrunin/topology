...
A collection $\{V_\alpha\}$ of open subsets in a topological space $\c{X}$ is called its \index{open cover}\emph{open cover} if it covers the whole $\c{X}$;
...
A subset of $\{V_\alpha\}$ that is also a cover is called its \index{subcover}\emph{subcover}.
\end{thm}
...
The condition in the above proposition is called \index{finite intersection property}\emph{finite intersection property};
...
sometimes it is called \index{17 camels trick}\emph{17 camels trick}%
