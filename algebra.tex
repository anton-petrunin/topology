...
In this chapter we explain how to use this bridge.
In this chapter we describe
In the next chapter, we will calculate fundamental group of the circle --- this will be the first example of a space with nontrivial fundamntal group.
Once this group is calculated, the connections of this chapter will lead to many applications.
...
\begin{subthm}{}
Show that is $A$ is deformation retract then $r_*$ and $\iota_*$ are isomorphisms.
\end{subthm}
