...
In this chapter we show that crossing this bridge respects maps between topological spaces;
in a more fancy language, the passage from a space to its fundamental group is determined by a \index{functor}\emph{functor}.
...
consider the path from $q_0$ to $q_1$ defined by $h(\tau)=\phi_\tau(p)$.
Show that
